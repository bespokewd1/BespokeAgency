var typing = new Typed(".cs-changing-text", {
  strings: ["Website", "Branding", "Social Media"],
  typeSpeed: 100,
  backSpeed: 40,
  loop: true,
  backDelay: 2000,
...
document
  ...
  .addEventListener("click", function (event) {
    ...
    if (domainInput) {
      ...
      const baseLink =
        "https://namecheap.pxf.io/c/5804036/386170/5618?u=https%3A%2F%2Fwww.namecheap.com%2Fdomains%2Fregistration%2Fresults.aspx%3Fdomain%3D";
