...
const svgVariantsPhone: Variants = {
  default: { opacity: 0, filter: 'blur(12px)' },
  enter: {
    opacity: 1,
    filter: 'blur(0px)',
...
const svgVariantLaptop: Variants = {
  default: { opacity: 0, filter: 'blur(12px)' },
  enter: {
    opacity: 1,
    filter: 'blur(0px)',
...
export const ProgressiveApp = forwardRef<SVGSVGElement, WaveSvgProps>(
  ({ className, ...rest }, ref) => {
    return (
      // <svg
      //   ref={ref}
...
ProgressiveApp.displayName = 'ProgressiveApp';
