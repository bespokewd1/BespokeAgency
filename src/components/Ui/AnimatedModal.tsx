    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          className="fixed inset-0 z-10001 flex h-full w-full items-center justify-center [perspective:800px] [transform-style:preserve-3d]"
        >
          <Overlay />
  ...
  return (
    ...
    >
      <svg
        ...
        className="h-4 w-4 text-black transition duration-200 group-hover:scale-125 group-hover:rotate-3"
      >
